          ...
          <div class="card-body">
            <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="exampleInputnomortelepon" name="nomortelepon" value="{{ $data->nomortelepon }}">
              </div>
              <div class="mb-3">
                <label for="exampleInputusia" class="form-label">Usia</label>
                <input type="text" class="form-control" id="exampleInputusia" name="usia" value="{{ $data->nomortelepon }}"">
              </div>
